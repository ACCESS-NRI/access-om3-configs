...
### Quick contributions 
!!! tip
    This method has the advantage is that it's *very quick*. The caveat is that, unless you have write access to the `access-om3-configs` repository, you will not be able to preview the changes rendered into a website or create whole new pages. <br>
