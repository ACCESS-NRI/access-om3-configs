If you don't want to use a precompiled executable from an [ACCESS-OM3 release](https://github.com/COSIMA/access-om3/wiki/Releases), you can build it yourself.
