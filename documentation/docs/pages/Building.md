...
4. **Update component repositories**
    ...
    For each model-component (MOM6, CICE, WW3)
...
6. **Tag the build components**: Once you are happy with the build, tag each model component fork with the new release number. Typically the first release from a 2025.08 branch would be 2025.08.000, or from the CICE6.6.1-x branch would be CICE6.6.1-0
