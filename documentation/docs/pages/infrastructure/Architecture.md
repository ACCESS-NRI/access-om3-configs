...
!!! tip
    ...
    4. click the tag icon to view the source code (note, however, that GitHub searches are restricted to the latest commit on the default branch, typically called "main" or "master")
