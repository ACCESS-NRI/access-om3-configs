...
```python
ocean_grid_generator.py -r 4 --no_south_cap --ensure_nj_even --mercator_lower_lat -75 --mercator_upper_lat 65 --match_dy so --shift_equator_to_u_point --south_ocean_lower_lat -81
```
