...
For details on `make_diag_table` and `diag_table`, see [here](https://decoding-access-om3.readthedocs.io/season1/#specifying-model-outputs-via-diag_table-or-make_diag_table) and [here](https://mom6.readthedocs.io/en/dev-gfdl/api/generated/pages/Diagnostics.html).
