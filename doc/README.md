...
The files in here should be the minimum required to support code search from links in the 
[ACCESS-OM3 docs](https://access-om3-configs.access-hive.org.au/). They are automatically kept 
up to date with a github workflow
