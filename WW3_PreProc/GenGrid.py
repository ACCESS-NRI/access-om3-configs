...
This script generates a grid from an Ocean_hgrid file for use with the WAVEWATCH III (WW3) model.
...
Input: ocean_hgrid.nc, ocean_topog.nc
...
grid_handle = NC.Dataset('/g/data/ik11/inputs/cime/inputdata/2023-03-10/ocn/mom/gx1v6/ocean_hgrid.nc', mode='r')
topog_handle = NC.Dataset('/g/data/ik11/inputs/cime/inputdata/2023-03-10/ocn/mom/gx1v6/ocean_topog.nc', mode='r')
